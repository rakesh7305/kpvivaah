            ...
            <div className={classes.searchSection}>
              ...
              <form onSubmit={submitHandler} className={classes.searchForm}>
                {/* <FormControl sx={{ m: 1, minWidth: 120 }}>
                  ...
                  <Select native defaultValue="" id="grouped-native-select" label="Gender">
                ...
                <Box
                  ...
                  sx={{ m: 1, minWidth: 400 }}
                >
                  {/* <FormControl size="small" variant="filled" className={classes.searchInput} fullWidth>
                  ...
                  <FormControl size="small" variant="filled" className={classes.searchInput} fullWidth>
                    ...
                    >
                      ...
                      <MenuItem value={10}>2002</MenuItem>
                      <MenuItem value={20}>2001</MenuItem>
                      <MenuItem value={20}>2000</MenuItem>
                      <MenuItem value={20}>1999</MenuItem>
                      <MenuItem value={20}>1998</MenuItem>
                      <MenuItem value={20}>1997</MenuItem>
                      <MenuItem value={20}>1996</MenuItem>
                      <MenuItem value={20}>1995</MenuItem>
